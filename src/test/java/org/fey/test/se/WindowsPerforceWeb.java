...
public class WindowsPerforceWeb {


        @SuppressWarnings({"unused"})
        @Test(groups = {"sanity"})
        public void testSelenium4Web() throws Exception{
...

            {
                ...
                perfectoOptions.put("scriptName", "Windows-Chrome-Webtest-Perforce");
...
// Reporting client. For more details, see https://github.com/perfectocode/samples/wiki/reporting
                ...
                try {
                   ...
                   //String textCheck = (String) driver.findElement(By.xpath("//*[contains(text(),'fey')]"));

                    WebElement textCheck = driver.findElement(By.xpath("//*[contains(text(),'fey')]"));
                    String textValidate = driver.toString();

                    if (textValidate.equalsIgnoreCase("true")) {
